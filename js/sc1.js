...
button.onclick = function () {
	...
	(function () {
		...
		calcData.osbSumma = calcData.s1 + calcData.s1; //osbSumm
		...
		calcData.sidingSummary  = calcData.s3 + calcData.s5; //sidingSummary v18
		...
		inHtml('wood50x50Roof', calcData.wood50x50Roof);
		...
		inHtml('sidingSummary', calcData.sidingSummary);
